...
public class XListViewHeader extends LinearLayout {
    ...
    public void setState(int state) {
        ...
        switch (state) {
            ...
            case STATE_SUCCESS:
                ...
                SharedPreferencesCompat.EditorCompat.getInstance().apply(editor);//提交修改
                break;
            case STATE_FRESH_FAILT:
                ...
                SharedPreferencesCompat.EditorCompat.getInstance().apply(editor1);//提交修改
                break;
            default:
        }
        mState = state;
    ...
    void setRefreshStampTag(String tag) {
        mId = tag;
    }
    ...
    public void refreshUpdatedAtValue() {
        ...
        if (lastUpdateTime == -1) {
            ...
            updateAtValue = String.format(getResources().getString(R.string.xlistview_updated_at), value);
